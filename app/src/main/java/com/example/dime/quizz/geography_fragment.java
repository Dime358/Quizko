...
public class geography_fragment extends Fragment {

    Integer br;

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.geography_fragment, container, false);


        questions_database dt = new questions_database(getActivity());
        Cursor questions = dt.getAnsweredQUestions("geography",1,1);
        ...
        questions = dt.getAnsweredQUestions("geography",2,1);
        br = questions.getCount();

        TextView progres2 = (TextView)v.findViewById(R.id.progres2);
        progres2.setText("Ниво 2:   "+br+ "/10");

        questions = dt.getAnsweredQUestions("geography",3,1);
        br = questions.getCount();
        ...
        Button geography_btn = (Button) v.findViewById(R.id.btn_geography);
        geography_btn.setOnClickListener(new View.OnClickListener() {
            @Override
